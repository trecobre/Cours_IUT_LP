...
public class EjbDepartementService implements DepartementService {
    ...
    public Departement synchronizeDepartement(Departement departement) {
        logger.log(Level.INFO, "Syncronized departement with name " + departement.getNom());
        if(departement.getId() != null){
            departement = entityManager.merge(departement);
        }
        else{
    ...
    public void deleteDepartement(Long id) {
        ...
        logger.log(Level.INFO, "Deleting departement with name " + departement.getNom());
        Etudiant.updateDepartement(entityManager, id, null);
